...
![[그림 1] 증가하는 RansomHub 피해자 (자료 - check point)](image.png)
...
- 타겟 국가 : 미국, 말레이시아, 인도
    ...
    ![[그림 2] 2024년 1월부터 9월까지 타겟 국가 (자료 - trendmicro)](image%201.png)
...
![[그림 4] 2024년 RansomHub 공격 시나리오 (자료 - KARA 랜섬웨어 동향 보고서)](image%203.png)
...
- Knight(Cyclops) 리브랜딩
    ...
    ![[그림 5] Knight(상), RansomHub(하) 명령줄 도움 (자료 - symantec)](image%204.png)
...
- ALHPV(BlackCat) 리브랜딩
    ...
    ![[그림 6] RansomHub(상), ALHPV(하) 랜섬노트 일부 (자료 - KARA 랜섬웨어 동향 보고서)](image%205.png)
...
![[그림 7] RansomHub의 첫 번째 게시물 (자료 - forescout)](image%206.png)

[그림 7] RansomHub의 첫 번째 게시물 (자료 - forescout)

RansomHub는 2월 2일에 koley가 RAMP 포럼에서 새로운 RaaS 프로그램을 발표하였다.

![[그림 8] 다크웹 포럼에서 RansomHub 원격 암호화 기능 발표  (자료 - forescout)](image%207.png)
...
![[그림 9] RansomHub에 게시된 공지 사항](image%208.png)
